...
type Charactors = keyof ICharactersTable;
...
const DashBoardTable: React.FC<ITable> = (props: ITable) => {
  ...
  const onChange: TableProps<ICharactersTable>['onChange'] = (newPagination, filters:any) => {
    const object:any = {};
  ...
  const getColumnSearchProps = (dataIndex: Charactors): ColumnType<ICharactersTable> => ({
    filterDropdown: ({
      setSelectedKeys,
      selectedKeys,
      confirm,
